...
export function Card1({srcImagem, textoParaAcao, titulo}){
    ...
    <Grid item sx={{position: "relative", p:2}} xs={12} md={4}>
        ...
        <Image width={640} height={490} alt="apple" src={srcImagem} style={{maxWidth:"100%"}}/>
                    {textoParaAcao &&   <Box sx={{width:400, position:"relative", display:"flex", justifyContent:"center", alignItems:"center"}}>
                    <Button variant="contained" sx={{display:"block", position: "absolute", bottom: "20px",}}>
                        {textoParaAcao}
                    </Button>
                    </Box>}
    </Grid>
